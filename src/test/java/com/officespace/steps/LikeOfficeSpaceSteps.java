package com.officespace.steps;

import com.officespace.driver.Driver;
import com.officespace.pages.FacebookScreen;
...
public class LikeOfficeSpaceSteps {
    ...
    public void user_searches_and_opens_page(String page) throws InterruptedException {
        facebookScreen.searchOfficeSpaces(page);
        Thread.sleep(30000);
    }
